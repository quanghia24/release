...
func (x *TripPreviewRequest) Reset() {
	*x = TripPreviewRequest{}
	mi := &file_trip_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TripPreviewRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TripPreviewRequest) ProtoMessage() {}

func (x *TripPreviewRequest) ProtoReflect() protoreflect.Message {
	mi := &file_trip_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use TripPreviewRequest.ProtoReflect.Descriptor instead.
func (*TripPreviewRequest) Descriptor() ([]byte, []int) {
	return file_trip_proto_rawDescGZIP(), []int{0}
}

func (x *TripPreviewRequest) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
func (x *TripPreviewRequest) GetPickup() *Coordinate {
	if x != nil {
		return x.Pickup
	}
	return nil
...
func (x *TripPreviewRequest) GetDestination() *Coordinate {
	if x != nil {
...
func (x *TripPreviewResponse) Reset() {
	*x = TripPreviewResponse{}
	mi := &file_trip_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TripPreviewResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TripPreviewResponse) ProtoMessage() {}

func (x *TripPreviewResponse) ProtoReflect() protoreflect.Message {
	mi := &file_trip_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TripPreviewResponse.ProtoReflect.Descriptor instead.
func (*TripPreviewResponse) Descriptor() ([]byte, []int) {
	return file_trip_proto_rawDescGZIP(), []int{1}
}

func (x *TripPreviewResponse) GetTripID() string {
	if x != nil {
		return x.TripID
	}
	return ""
...
func (x *TripPreviewResponse) GetRoute() *Route {
	if x != nil {
		return x.Route
	}
	return nil
...
func (x *TripPreviewResponse) GetRideFares() []*RideFare {
	if x != nil {
		return x.RideFares
	}
	return nil
...
type Trip struct {
	...
	TripDriver       *TripDriver            `protobuf:"bytes,6,opt,name=tripDriver,proto3" json:"tripDriver,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *Trip) GetTripDriver() *TripDriver {
	if x != nil {
		return x.TripDriver
	}
	return nil
...
const file_trip_proto_rawDesc = "" +
	...
	"\x13TripPreviewResponse\x12\x16\n" +
	...
	"\bgeometry\x18\x03 \x03(\v2\x0e.trip.GeometryR\bgeometry\"\x82\x01\n" +
	"\bRideFare\x12\x0e\n" +
	...
	"\x06userID\x18\x05 \x01(\tR\x06userID\x120\n" +
	"\n" +
	"tripDriver\x18\x06 \x01(\v2\x10.trip.TripDriverR\n" +
	"tripDriver\"t\n" +
	"\n" +
	"TripDriver\x12\x0e\n" +
	...
	"\vTripService\x12B\n" +
	"\vTripPreview\x12\x18.trip.TripPreviewRequest\x1a\x19.trip.TripPreviewResponse\x12?\n" +
	"\n" +
...
var file_trip_proto_goTypes = []any{
	(*TripPreviewRequest)(nil),  // 0: trip.TripPreviewRequest
	(*TripPreviewResponse)(nil), // 1: trip.TripPreviewResponse
...
var file_trip_proto_depIdxs = []int32{
	2,  // 0: trip.TripPreviewRequest.pickup:type_name -> trip.Coordinate
	2,  // 1: trip.TripPreviewRequest.destination:type_name -> trip.Coordinate
	3,  // 2: trip.TripPreviewResponse.route:type_name -> trip.Route
	4,  // 3: trip.TripPreviewResponse.rideFares:type_name -> trip.RideFare
	...
	9,  // 9: trip.Trip.tripDriver:type_name -> trip.TripDriver
	0,  // 10: trip.TripService.TripPreview:input_type -> trip.TripPreviewRequest
	6,  // 11: trip.TripService.CreateTrip:input_type -> trip.CreateTripRequest
	1,  // 12: trip.TripService.TripPreview:output_type -> trip.TripPreviewResponse
